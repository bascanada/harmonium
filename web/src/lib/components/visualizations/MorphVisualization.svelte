<script lang="ts">
  ...
  const PRESET_LOCATIONS = [
    ...
    { id: 'p_dark_drone', name: 'Dark Drone', x: -0.7, y: 0.1, plane: 'emotional', color: '#60a5fa50' },
    { id: 'p_aggro_bass', name: 'Aggro Bass', x: -0.5, y: 0.9, plane: 'emotional', color: '#f8717150' },
    { id: 'p_bright_lead', name: 'Bright Lead', x: 0.6, y: 0.8, plane: 'emotional', color: '#facc1550' },
