...
<Card title="Harmony" class="border-l-4 border-l-green-500">
	<!-- Harmony Engine Mode -->
	<div class="mb-4">
		<ToggleGroup
			type="single"
	...
	<p class="mb-4 text-center text-xs text-neutral-500">
		{engineState.harmonyMode === 0
			? 'Russell Circumplex (I-IV-vi-V)'
			: 'Steedman + Neo-Riemannian + LCC'}
	</p>
