...
mod tests {
    ...
    fn test_profile_creation() {
        let profile = DNAProfile::new("test");
    ...
    fn test_from_dna_collection() {
        ...
        let profile = DNAProfile::from_dna_collection("test", &dnas);
    ...
    fn test_predefined_profiles() {
        let baroque = DNAProfile::baroque();
        let jazz = DNAProfile::jazz();
    ...
    #[test]
    fn test_is_similar() {
        let a = DNAProfile::baroque();
        let b = DNAProfile::baroque();
        let c = DNAProfile::jazz();
